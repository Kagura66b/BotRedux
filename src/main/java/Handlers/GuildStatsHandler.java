...
public class GuildStatsHandler extends ListenerAdapter {
    ...
    public GuildStatsHandler(GuildMessageReceivedEvent event){
    ...
    public void onGuildMessageReceived(@NotNull GuildMessageReceivedEvent event) {
        ...
        if(event.getChannel().equals(channel)&&!event.getAuthor().isBot()&&event.getAuthor().equals(user)){
            if(dataSet1[0] == 0){
                ...
                if(args.length!=4){
                    ...
                    if(args[2].toLowerCase().equals("true") || args[2].toLowerCase().equals("t")){
                        dataSet1[2] = 1;
                    }
                    if(args[3].toLowerCase().equals("true") || args[3].toLowerCase().equals("t")){
                        dataSet1[3] = 1;
                    }
